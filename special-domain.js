...
// ── Static Meta IP mapping ──
// Each Meta CDN edge IP serves a specific class of hostnames.
// Mapped from Google DoH responses (China vantage, June 2026).
// All IPs verified reachable via TCP/443 + TLS handshake + ECH-compatible.
...
/**
 * Resolve a Meta domain to known-reachable IPs from the static map.
