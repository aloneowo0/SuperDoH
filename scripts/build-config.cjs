...
async function main() {
  ...
  const templatesContent = `// Auto-generated by scripts/build-config.cjs from frontend/*.html\n// Do not edit manually — edit frontend/index.html and frontend/en.html instead\nexport const HTML_CN = ${JSON.stringify(htmlCn)};\nexport const HTML_EN = ${JSON.stringify(htmlEn)};\n`;
